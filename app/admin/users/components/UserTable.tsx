...
const TableHeader = ({ children, width }: { children: React.ReactNode; width: string }) => (
  <div className={`flex gap-2.5 justify-center items-center px-2.5 py-4 font-bold ${width}`}>
    {children}
  </div>
);
    ...
    <div className="mt-4 w-full font-medium text-center text-stone-500 max-md:max-w-full">
      <div className="overflow-x-auto">
        ...
        <div className="text-[12px] font-bold flex flex-nowrap gap-2 justify-between items-center px-4 w-full font-bold rounded bg-zinc-100 text-neutral-600 min-w-fit">
          ...
          <TableHeader width="w-[100px]">회원코드</TableHeader>
          ...
          {isWithdrawn && (
            <TableHeader width="w-[120px]">탈퇴사유</TableHeader>
          )}
        ...
        {userData.map((user, index) => (
          ...
          >
            ...
            <TableCell width="w-[100px]">{user.code}</TableCell>
            ...
            <TableCell width="w-16" className="py-3.5">
              ...
              >
                <Image src='/setting.svg' alt='setting' width={18} height={18} />
